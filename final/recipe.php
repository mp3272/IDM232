 ...
 <h3>You might also like:</h3> 
	<div id="portfolio">
		<div class="grid">
				...
				$limit = 6;
				$offset = $limit * ($page-1);
				$result = mysqli_query($link, "SELECT * FROM recipe WHERE category like '%".mysqli_real_escape_string($link, $recipe['category'])."%' AND recipeid != $recipeid ORDER BY recipeid DESC LIMIT $offset, $limit");
				$i = 0;
				$r = 0;
